...
import { Circle, ArrowRightIcon } from "lucide-react";
...
function HeroGeometric({
    ...
    return (
        <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-cepheus-dark">
            <div className="absolute inset-0 bg-gradient-to-br from-cepheus-green/[0.05] via-transparent to-cepheus-accent/[0.05] blur-3xl" />
            ...
            <div className="absolute inset-0 overflow-hidden">
                <ElegantShape
                    ...
                    height={140}
                    rotate={12}
                    gradient="from-cepheus-green/[0.15]"
                ...
                <ElegantShape
                    ...
                    height={120}
                    rotate={-15}
                    gradient="from-cepheus-accent/[0.15]"
                ...
                <ElegantShape
                    ...
                    height={80}
                    rotate={-8}
                    gradient="from-cepheus-green-light/[0.15]"
                ...
                <ElegantShape
                    ...
                    height={60}
                    rotate={20}
                    gradient="from-cepheus-green-dark/[0.15]"
            ...
            <div className="relative z-10 container mx-auto px-4 md:px-6 pt-16">
                <div className="max-w-3xl mx-auto text-center">
                    <motion.div
                        ...
                        initial="hidden"
                        animate="visible"
                        className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cepheus-darker/50 border border-cepheus-gray-dark/30 mb-8 md:mb-12"
                    >
                        <Circle className="h-2 w-2 fill-cepheus-green" />
                        <span className="text-sm text-cepheus-gray-light tracking-wide">
                            {badge}
                        </span>
                    </motion.div>
                    ...
                    >
                        <h1 className="text-4xl sm:text-6xl md:text-7xl font-bold mb-6 md:mb-8 tracking-tight">
                            ...
                            <span
                                className={cn(
                                    "bg-clip-text text-transparent bg-gradient-to-r from-cepheus-green to-cepheus-accent"
                                )}
                            >
                                {title2}
                            </span>
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-cepheus-dark via-transparent to-cepheus-dark/80 pointer-events-none" />
        </div>
    );
}
